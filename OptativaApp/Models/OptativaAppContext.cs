...
namespace OptativaApp.Models
{
    public class OptativaAppContext : DbContext
    {
        ...
        // 
        // System.Data.Entity.Database.SetInitializer(new System.Data.Entity.DropCreateDatabaseIfModelChanges<OptativaApp.Models.OptativaAppContext>());

        public OptativaAppContext() : base("name=OptativaAppContext")
        {
        }
